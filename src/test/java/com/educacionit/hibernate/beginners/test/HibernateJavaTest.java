...
public class HibernateJavaTest {
    ...
    private static final Logger logger = LoggerFactory.getLogger (HibernateJavaTest.class);


    public HibernateJavaTest () {
    ...
    public void m1 () {
        ...
        try {
            ...
            EmployeeAnnotation[] values = new EmployeeAnnotation[]{
                    ...
                    new EmployeeAnnotation ("C-3PO", "Test", new Date ()),
                    new EmployeeAnnotation ("Lando Calrissian", "Test", new Date ()),
                    new EmployeeAnnotation ("Chewbacca", "Test", new Date ()),
                    new EmployeeAnnotation ("Boba Fett", "Test", new Date ()),
                    new EmployeeAnnotation ("Greedo", "Test", new Date ())
            };
